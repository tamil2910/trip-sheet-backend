...
@NoArgsConstructor
@AllArgsConstructor
public class DriverCodeLookupResponseDto {
  ...
  public static DriverCodeLookupResponseDto fromEntity(
      Driver driverEntity,
      Tenant currentTenant,
      DriverTenantMapping mapping
  ) {
    ...
    DriverSummary driver = new DriverSummary(
        ...
        mapping != null ? mapping.getActive() : driverEntity != null ? driverEntity.getActive() : null,
    ...
    return new DriverCodeLookupResponseDto(
        driverEntity != null ? driverEntity.getDriverCode() : null,
        mapping != null,
